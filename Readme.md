...
<p>A basic gradient Background Generator which allows to create a background by selecting your required colors. This will make up a gradient mix and provide the code line so that you can use it in your Website</p>
<br>
